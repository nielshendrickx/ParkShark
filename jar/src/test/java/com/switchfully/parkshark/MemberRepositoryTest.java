...
class MemberRepositoryTest {
    ...
    void saveThreeMembers_checkThatSizeIs3() {
        ...
        LicensePlate licensePlate = new LicensePlate("1-aaa-111", "BE");
        Member member = new Member("firstName", "lastName", "0473000000", "016000000", "email@test.com", address, licensePlate, new MembershipLevel(), "password");
        Member member2 = new Member("firstName2", "lastName2", "0473000000", "016000000", "email2@test.com", address, licensePlate, new MembershipLevel(), "password");
        Member member3 = new Member("firstName3", "lastName3", "0473000000", "016000000", "email3@test.com", address, licensePlate, new MembershipLevel(), "password");
